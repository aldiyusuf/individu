    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img src="images/sk.png" style="width:100px; margin-top: -7px;"></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/bc.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b><center>Persembahan spesial untuk anda, calon mempelai..</center><h1 style="color:#f97b61;"></b></h1></h2>
        <p><br>Terimakasih anda telah mengunjungi website RIAS PENGANTIN DARTIK Ini adalah website official kami yang selanjutnya akan memberikan berbagai macam informasi terkait dengan kegiatan yang biasanya kami lakukan info lebih lengkap hubungi 0813-9319-7442.</br>
		<br>Creative Wedding Organizer merupakan Wedding Organizer, Wedding Planner yang menyediakan Jasa maupun Paket Wedding untuk persiapan sampai pelaksanaan acara pernikahan dari berbagai kebutuhan yang di perlukan untuk sebuah Pesta pernikahan dengan budjet minimal hasil yang megah dan elegant.</br>
		</p>
      </div>
    </div>
    </div>
...
<b>Pelaminan</b>
    ...
    <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang weddingORGANIZER</b></h3></li>
        </ul></center>
          <hr>
        <ul>
          <li><b>weddingORGANIZER</b> adalah</li>
          <li>Sebuah jasa khusus yang dan</li>
          <li>membantu calon pengantin</li>
          <li>keluarga dalam pelaksaan</li>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li>Jl.Jakenan-winong,km 30</li>
          <li>jakenan,juwana</li>
          <li>Pati</li>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>&copy; @2018 web development </center>
        </div>
      </div>
  </body>
</html>
