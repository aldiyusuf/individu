  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#"><img src="images/sk.png"style="width:100px; style="width:150px; margin-top: -7px;"></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="gambar/<?php echo $data['gambar']; ?>" style="width:250px; height:250px;">   
      ...
      <div class="col-md-6" style="margin-left:10px ; margin-top:10px;">
        <table>
        	<tr>
        		<h3><td><b>Model</b></td>		<td>: <?php echo $data['judul']; ?></td></h3>
        	</tr>

        	<tr>
        		<h3><td><b>Asal</b></td>		<td>: <?php echo $data['penerbit']; ?></td></h3>
        	</tr>

        	<tr>
        		<h3><td><b>Desain</b></td>		<td>: <?php echo $data['pengarang']; ?></td></h3>
        	</tr>

        	<tr>
        		<h3><td><b>Versi</b></td>		<td>: <?php echo $data['halaman']; ?></td></h3>
        	</tr>
