    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#0000ff;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Wedding<b>Organizer</b></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="index.php">Paket</a></li>
            <li><a href="index.php?page=kategori">Pemesanan</a></li>
            <li><a href="index.php?page=buku">Daftar Pemesanan</a></li>
