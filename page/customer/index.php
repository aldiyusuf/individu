...
<html lang="en">
  <head>
    ...
    <title>Wedding Organizer page Customer</title>
...
<li><a href="../admin/outpage.php"><span class="glyphicon glyphicon-log-out">Keluar</span></a></li>
    ...
    <div class="jumbotron">
     ...
     <img src="../../img/contoh.jpg" width=500px height=300px >   
    </div>
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <center><h2><b>Welcome To Sanggar Rias Dartik<h1 style="color:#f97b61;"></center><center>
		<p><b>Sanggar Rias Dartik adalah suatu jasa khusus yang kami buat yang berfungsi secara pribadi membantu calon pengantin dan keluarga dalam perencanaan dan supervisi pelaksanaan rangkaian acara pesta pernikahan sesuai dengan jadwal yang telah ditetapkan</b></center></h1></h2>
        <p></p></p>
      </div>
    </div>
    </div>
